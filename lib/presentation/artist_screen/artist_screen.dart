import '../artist_screen/widgets/thumbnailssection_item_widget.dart';
...
import 'package:shoko_tech_s_application1/widgets/app_bar/appbar_leading_image.dart';
import 'package:shoko_tech_s_application1/widgets/app_bar/appbar_title.dart';
import 'package:shoko_tech_s_application1/widgets/app_bar/appbar_trailing_image.dart';
import 'package:shoko_tech_s_application1/widgets/app_bar/custom_app_bar.dart';
import 'package:shoko_tech_s_application1/widgets/custom_icon_button.dart';
...
class ArtistScreen extends StatelessWidget {
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(children: [
                  _buildRenaissanceSection(context),
  ...
  /// Section Widget
  Widget _buildRenaissanceSection(BuildContext context) {
            ...
            child: BlocSelector<ArtistBloc, ArtistState, ArtistModel?>(
                ...
                builder: (context, artistModelObj) {
                  return ListView.separated(
                      ...
                      itemCount:
                          artistModelObj?.thumbnailssectionItemList.length ?? 0,
                      itemBuilder: (context, index) {
                        ThumbnailssectionItemModel model =
                            artistModelObj?.thumbnailssectionItemList[index] ??
                                ThumbnailssectionItemModel();
                        return ThumbnailssectionItemWidget(model,
                            onTapUrgentSiege: () {
